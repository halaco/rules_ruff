...
def _ruff_repo_impl(repository_ctx):
    ...
    # HACK: Use stripPrefix instead of strip_prefix, the keyword parameter stripPrefix is
    # renamed to strip_prefix after bazel 8.0.0. But we need to use stripPrefix to
    # support bazel older than 8.0.0.
