...
some other ruleset that depends on rules_ruff, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_ruff=$(pwd)/rules_ruff"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_ruff` on your system will point to this folder.
...
https://github.com/halaco/rules_ruff/actions/workflows/tag.yaml
